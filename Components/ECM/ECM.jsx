...
export const ECM = ({ path }) => {
    ...
    await app.fileManager.processFrontMatter(manifestFile, (data) => {
      data["components"] = data["components"]
        ...
        .map((c) => {
          ...
          return undefined;
          // need to figure out how to strip out the removed components
          // while also adding the new ones and updating the existing ones
        })
        .filter(Boolean);
      return data;
    });
  ...
  const deleteComponent = async (name) => {
    try {
      ...
      console.log(`Component ${name} deleted`, updatedComponents);
          ...
          <Fragment key={component.filePath}>
            <li>
              ...
              {component.protected ? (
                ...
                <>
                  <a
                    onClick={async () => await deleteComponent(component.name)}
                  >
                    Delete
                  </a>
                </>
